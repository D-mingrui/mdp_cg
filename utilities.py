...
def cal_d_t_dc(pickup_nodes, delivery_nodes, set_P, set_N, depot, f_cost, speed):
    # 计算坐标和距离、时间、成本字典
    order_num = len(pickup_nodes)
    start_node = 0
